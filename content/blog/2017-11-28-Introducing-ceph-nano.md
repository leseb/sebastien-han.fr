...
date: 2017-11-28 19:23:14
slug: Introducing-ceph-nano
draft: false
categories: ["containers"]
tags: ["container", "ceph"]
---

![Introducing ceph-nano](/images/introducing-ceph-nano.png)

I've recently started a small project that aims to help developers working with the S3 API.
The program is called `cn` for Ceph Nano, is available on [github](https://github.com/ceph/cn) let me give you a tour of what it does.
...
Before you ask "why not using s3cmd instead?", then you will be happy to read that internally cn uses `s3cmd` and act as a wrapper around the most commonly used commands.
...
> To all the designers out there, if someone wants to work on a little logo for ceph-nano that'll be really awesome.
I guess that when it comes to design I'm only good with diagram, for the rest I just suck :).
