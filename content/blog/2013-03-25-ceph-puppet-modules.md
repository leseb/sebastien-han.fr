---
title: Ceph Puppet Modules
date: 2013-03-25 15:58:00
slug: ceph-puppet-modules
draft: false
categories: ["ceph"]
tags: ["ceph"]
---

Quite recently [François Charlier](https://github.com/fcharlier) and I worked together on the [Puppet](https://puppetlabs.com/)  modules for [Ceph](ceph.com) on behalf of our employer [eNovance](enovance.com). In fact, François started to work on them last summer, back then he achieved the Monitor manifests. So basically, we worked on the OSD manifest. Modules are in pretty good shape thus we thought it was important to communicate to the community. That's enough talk, let's dive into these modules and explain what do they do. See below what's available:

* Testing environment is [Vagrant](www.vagrantup.com) ready.
