...
date: 2015-07-06 14:11:00
slug: ceph-enable-the-object-map-feature
draft: false
categories: ["ceph"]
tags: ["ceph"]
---

![Ceph enable the object map feature](/images/ceph-enable-the-object-map-feature.jpg)
...
The future CLI version will be easier, as you won't need to use digits anymore.
The proper name of the feature will be used instead.
After the image creation, you will be able to add more features too.
