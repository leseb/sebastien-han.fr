...
date: 2014-07-07 15:59:00
slug: start-with-the-rbd-support-for-tgt
draft: false
categories: ["ceph"]
tags: ["ceph"]
---

![Start with the RBD support for TGT](/images/ceph-rbd-tgt.jpg)

A couple a months ago, [Dan Mick](http://ceph.com/dev-notes/adding-support-for-rbd-to-stgt/) posted a nice article that introduced the RBD support for iSCSI / TGT.
...
pool 'iscsi' created
$ rbd -p iscsi create iscsi-rbd -s 10240
```
...
192.168.0.100:3260,1 iqn.2014-04.rbdstore.example.com:iscsi
```
...
Logging in to [iface: default, target: iqn.2014-04.rbdstore.example.com:iscsi, portal: 192.168.0.100,3260] (multiple)
Login to [iface: default, target: iqn.2014-04.rbdstore.example.com:iscsi, portal: 192.168.0.100,3260] successful.
```
...
rw   256   512  4096          0     10737418240   /dev/sdh
```
