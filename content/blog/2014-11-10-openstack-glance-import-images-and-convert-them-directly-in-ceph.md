...
date: 2014-11-11 23:45:00
slug: openstack-glance-import-images-and-convert-them-directly-in-ceph
draft: false
categories: ["openstack"]
tags: ["openstack"]
---

![OpenStack Glance: import images and convert them directly in Ceph](/images/glance-convert-in-ceph.jpg)
...
The good thing here is that we can trigger the conversion directly from Ceph and this using the `qemu-img` tool.
Prior to run the convertion make sure that your `ceph.conf` is configured to force the creation of images 2 format (`rbd default format = 2`).
