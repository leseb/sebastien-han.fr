...
slug: analyse-openstack-guest-writes-and-reads-running-on-ceph
draft: false
categories: ["ceph"]
tags: ["ceph"]
---

![Analyse OpenStack guest writes and reads running on Ceph](/images/librbd-io-pattern.jpg)
...
**The path of the log file must be writable by QEMU.**
The log show the offset and the lenght of the IO that was submitted.
