...
date: 2014-12-17 20:29:00
slug: ceph-collect-kernel-rbd-logs
draft: false
categories: ["ceph"]
tags: ["ceph"]
---

![Ceph: collect Kernel RBD logs](/images/ceph-collect-krbd-logs.jpg)
...
You can use this [script](https://github.com/ceph/ceph/blob/master/src/script/kcon_all.sh) from the Ceph repo as well to enable all of them:
