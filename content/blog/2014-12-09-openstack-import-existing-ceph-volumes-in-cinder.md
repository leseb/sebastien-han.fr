...
date: 2014-12-09 16:14:00
slug: openstack-import-existing-ceph-volumes-in-cinder
draft: false
categories: ["openstack"]
tags: ["openstack"]
---

![OpenStack: import existing Ceph volumes in Cinder](/images/openstack-import-existing-vol-ceph-cinder.jpg)
...
> Imagine you have operating system instances configured with a legacy application that can only run once.
Imagine that you want to run them in Ceph using Cinder booting from volumes. Then this is probably how you will import them.
...
5. Remove the volume since RBD won't allow overwrite: `rbd -p volumes rm <volume-uuid>`
