...
date: 2014-04-09 16:46:00
slug: ceph-maintenance-with-ansible
draft: false
categories: ["ceph"]
tags: ["ceph"]
---

![Ceph maintenance with Ansible](/images/ceph-maintenance-with-ansible.jpg)
...
By running this playbook you will set the `noout` flag on your cluster, which means that OSD **can't** be marked as out of the CRUSH map, but they will be marked as down.
