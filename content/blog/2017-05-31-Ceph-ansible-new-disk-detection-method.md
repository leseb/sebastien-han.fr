---
title: "Ceph ansible: new disk detection method"
date: 2017-05-31 21:49:53
slug: Ceph-ansible-new-disk-detection-method
draft: true
categories: ["ansible"]
tags: ["ansible", "ceph"]
---

![Title](/images/ceph-ansible-new-disk-detection-method.png)

In this article, I will explore one of the biggest feature I have been waiting for in [ceph-ansible](https://github.com/ceph/ceph-ansible).
This feature was developed by Erwan Velu.
...
* removing disks that doesn't match some criteria
...
A typical use case, is to use rotational disks for OSDs and SSDs for journals. To do that the following can do it:
...
You can run your ansible playbook with the `-vvvv` option which is very verbose.
