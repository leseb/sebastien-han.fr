...
date: 2013-06-03 15:11:00
slug: ceph-integration-in-openstack-grizzly-update-and-roadmap-for-havana
draft: false
categories: ["ceph"]
tags: ["ceph"]
---

![Ceph integration in OpenStack: Grizzly update and roadmap for Havana](/images/ceph-openstack-update-roadmap-havana.jpg)
...
With the help of this article, I'd like to share some of the discussions that we had and blueprints that we wrote.
...
Nothing for the time beeing and we didn't say much that much about it. However Ceilometer could track and report some specific metrics from the Ceph monitors.
The same goes for the RADOS Gateway and volume usage statistics.

<br />

## II.5 Alternative projects

New comers projects like key management system API have also been discussed (initially the authentication and the key management are handle by the monitors).
If Ceph could provide an API, the key management part could be detach from the monitors and then managed by a key management system.
